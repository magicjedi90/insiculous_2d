...
| I2 ◐ | Remaining games on the site — **ALL 5 STAGED Aug 19 2026** | snake/frogger/breakout/invaders/asteroids bundles synced to `public/games/<slug>/v1/`, pages flipped playable (frogger with width/height 720x768 frontmatter — schema + [slug].astro pass-through added), copy updated, `npm run verify` green (43 pages). Goes live on the next jesse→main merge |
